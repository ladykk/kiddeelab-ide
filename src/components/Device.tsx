...
import { Device as DeviceType, DeviceInfo } from "../types/device";
...
function Device() {
  ...
  return (
    <div className="min-h-[350px] bg-gray-100 flex flex-col border-b">
...
export function DeviceManage() {
  ...
  return (
    <Fragment>
      <div className="px-2 py-2 border-b bg-gray-50 flex items-center justify-between">
        <ToggleSwitch
          checked={showCode}
          label="Live Code"
